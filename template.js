angular.module('logrunsApp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('app/app/views/account.html',
    "<img></img>\n" +
    "\n" +
    "\n" +
    "\n" +
  ...
  $templateCache.put('app/app/views/calendar.html',
  ...
  $templateCache.put('app/app/views/entry.html',
    "<div class=\"entry\">\n" +
  ...
  $templateCache.put('app/app/views/fantasy.html',
  ...
  $templateCache.put('app/app/views/home.html',
    "<div class=\"entry\">\n" +
    "<div class=\"feed\">\n" +
  ...
  $templateCache.put('app/app/views/login.html',
  ...
  $templateCache.put('app/app/views/logout.html',
    "<div class=\"tile\">Get Outta HEEEEEEEEERE. You're OUT! SEE YA!</div>"
  );


  $templateCache.put('app/app/views/newentry.html',
    "<div class=\"entry logEntry\">\n" +
  ...
  $templateCache.put('app/app/views/notifications.html',
    "<div class=\"entry\">\n" +
    "<h1>Notifcations</h1>\n" +
    "<div class=\"feed\">\n" +
    "<div ng-repeat=\"entry in entries\">\n" +
  ...
  $templateCache.put('app/app/views/profile.html',
    "<div class=\"chart\"></div>\n"
  );


  $templateCache.put('app/app/views/search.html',
    "<div class=\"entry\">\n" +
    "<div class=\"feed\">\n" +
    "<div ng-repeat=\"entry in entries\">\n" +
    "<entry></entry>\n" +
  ...
  $templateCache.put('app/app/views/signup.html',
  ...
  $templateCache.put('app/app/views/statistics.html',
    "coming soon"
  );


  $templateCache.put('app/app/views/templates/entry-template.html',
  ...
  $templateCache.put('app/app/views/templates/toolbar-template.html',
  ...
  $templateCache.put('app/app/views/users.html',
    "<div class=\"entry\">\n" +
